// app/(staff)/staff/manager/courses/[id]/total-assignments/[assignmentId]/page.tsx
"use client";
  ...
  if (!assignment) {
    return (
      <div className="p-6 text-center" style={{ color: "var(--color-muted)" }}>
        ...
        <div className="mt-4">
          <Button onClick={() => router.push(`/staff/manager/courses/${id}/total-assignments`)} className="rounded-xl">
            ← Back
          </Button>
        </div>
      </div>
    ...
    <div className="p-5 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/staff/manager/courses/${id}/total-assignments`}>
