...
export default function SupportRequestResolvePrompt({ onConfirm, onDismiss, message }: Props) {
    return (
            ...
            <div className="max-w-lg w-full px-4">
                <div className="bg-gradient-to-r from-white/70 via-white to-[rgba(127,113,244,0.08)] border border-[var(--border)] shadow-lg rounded-3xl px-5 py-3 flex items-center gap-4 justify-between">
                    <div className="flex items-start gap-3">
                        <div className="flex-shrink-0 mt-0.5">
                            <div className="w-10 h-10 rounded-full bg-[rgba(127,113,244,0.12)] text-[var(--brand)] flex items-center justify-center shadow-sm">
