...
export default function ManagerLayout({
    ...
    return (
        <div className="min-h-screen flex bg-white">
            ...
            >
                <div
                    className={`fixed top-0 right-0 z-50 h-16 bg-white/80 border-b border-gray-200 supports-[backdrop-filter]:backdrop-blur-md transition-all duration-300 ${collapsed ? "sm:left-20" : "sm:left-64"
                        }`}
                >
