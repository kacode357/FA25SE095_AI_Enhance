            ...
            <div className="max-w-7xl mx-auto space-y-6">
                <div className="flex flex-row items-center justify-between gap-2">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight text-slate-900">Topic Weight History</h1>
                            <p className="text-slate-500 mt-1">Viewing history for: <span className="font-semibold text-blue-600">{currentTopicName || "Loading..."}</span></p>
                        </div>
                    </div>
                    <Button
                        variant="ghost"
