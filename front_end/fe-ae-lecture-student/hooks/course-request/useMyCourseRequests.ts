...
export function useMyCourseRequests() {
  ...
  const fetchMyCourseRequests = useCallback(
    async (params: GetMyCourseRequestsQuery, force = false) => {
  ...
  const refetch = (params: GetMyCourseRequestsQuery) =>
    fetchMyCourseRequests(params, true);
