    ...
    <div className="border border-slate-200 rounded-md p-3 bg-white">
      ...
      <div className="flex items-end gap-3 flex-wrap sm:flex-nowrap">
        ...
        <div className="flex flex-col flex-1 min-w-[180px]">
          <label className="text-[11px] text-slate-500 mb-1">Search course name</label>
        ...
        <div className="flex flex-col w-[150px] sm:w-[160px]">
          <label className="text-[11px] text-slate-500 mb-1">Course code</label>
          <Input
        ...
        <div className="flex flex-col w-[150px]">
          <label className="text-[11px] text-slate-500 mb-1">Created After</label>
          <div className="relative">
        ...
        {/* Created before */}
        <div className="flex flex-col w-[150px]">
          <label className="text-[11px] text-slate-500 mb-1">Created Before</label>
          <div className="relative">
            <Calendar className="size-3 text-slate-400 absolute left-2 top-1/2 -translate-y-1/2 pointer-events-none" />
            <input
              type="date"
        ...
        <div className="flex flex-col items-end ml-auto">
          <label className="text-[11px] text-transparent mb-1 select-none">Action</label>
