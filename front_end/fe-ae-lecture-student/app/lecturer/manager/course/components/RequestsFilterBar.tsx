...
export default function RequestsFilterBar({
  ...
  return (
    <div className="border cursor-default border-slate-200 rounded-md p-3 bg-white">
      <div className="flex items-center gap-2 text-slate-600 mb-2">
        <Filter className="size-4 cursor-default text-[#7f71f4]" />
        <span className="text-sm cursor-text text-[#000D83] font-medium">Filters</span>
      ...
      {stacked ? (
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col">
            <label className="text-sm text-slate-500 mb-1 cursor-text">Search name</label>
          ...
          {/* Lecturer */}
          <div className="flex flex-col">
            <label className="text-sm text-slate-500 mb-1 cursor-text">Lecturer</label>
            <div className="relative">
          ...
          {/* Status */}
          {/* <div className="flex flex-col">
            <label className="text-sm text-slate-500 mb-1 cursor-text">Status</label>
            <div className="relative">
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            <Button variant="outline" className="h-8 cursor-pointer px-2 text-sm text-brand border-brand hover:bg-brand/5" onClick={onClear}>
              Clear
            </Button>
            <Button className="h-8 cursor-pointer px-3 text-sm btn btn-gradient text-white rounded-md" onClick={onApply}>
              Apply
            </Button>
          </div>
        </div>
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-6 gap-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                value={createdAfter}
                onChange={(e) => setCreatedAfter(e.target.value)}
                className="h-8 text-sm border cursor-text border-slate-300 rounded-md px-6 bg-white w-full"
                placeholder="Created after"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                value={status}
                onChange={(e) => setStatus(e.target.value)}
                className="h-8 text-sm border border-slate-300 rounded-md pl-6 cursor-pointer bg-white w-full"
              >
                <option value="">All Statuses</option>
                <option value="1">Pending</option>
                <option value="2">Approved</option>
          ...
          <div className="flex items-center justify-end gap-2 mt-2">
            <Button variant="outline" className="h-8 cursor-pointer text-[#000D83] px-2 text-[11px] text-brand border-brand hover:bg-brand/5" onClick={onClear}>
              Clear
            </Button>
