...
import { FileSpreadsheet, HardDriveDownload, Info, Upload } from "lucide-react";
...
export default function ImportEnrollmentsPage() {
    ...
    return (
        <div className="px-4 pb-4 pt-2">
            <div className="sticky top-0 z-30 backdrop-blur w-full pr-5 py-3 mb-3">
                <h1 className="text-sm font-semibold uppercase tracking-wide">Import Enrollments</h1>
                    ...
                    <Card className="p-5 border-slate-200 shadow-sm">
                        ...
                        <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button className="text-violet-800 hover:text-violet-500" variant="ghost" onClick={() => router.push("/lecturer/course")}>
                                    Cancel
                                </Button>
                            </div>
                        </div>
