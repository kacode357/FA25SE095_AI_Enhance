...
export default function FilterBar({
  ...
  return (
    <div className="sm:px-4 sm:pb-2.5 border-b border-slate-200">
      ...
      {showAdvanced && (
        <div className={stacked ? "mt-5 grid grid-cols-1 gap-3" : "mt-5 grid grid-cols-2 md:grid-cols-4 gap-3"}>
          ...
          {/* Min enroll */}
          <div className="flex flex-col">
            <label className="text-xs text-slate-500 mb-1 cursor-text flex items-center gap-1"><Users className="size-3 text-brand" />Min enroll</label>
            <Input
              type="number"
              placeholder="0"
              value={minEnroll}
          ...
          {/* Max enroll */}
          <div className="flex flex-col">
            <label className="text-xs text-slate-500 mb-1 cursor-text flex items-center gap-1"><Users className="size-3 text-brand" />Max enroll</label>
            <Input
              type="number"
              placeholder="∞"
              value={maxEnroll}
