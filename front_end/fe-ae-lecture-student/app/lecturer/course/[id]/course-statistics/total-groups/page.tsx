...
export default function TotalGroupsPage() {
  ...
  const { listData: groups, loading, fetchByCourseId } = useGroupsByCourseId();
  ...
  useEffect(() => {
    ...
    // no reset() on useGroupsByCourseId
  }, [id, fetchByCourseId]);
  ...
  return (
    <div className="p-5 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => router.push(`/lecturer/course/${id}/course-statistics`)} className="rounded-xl btn btn-gradient-slow">
          ← Back
        </Button>
      </div>
