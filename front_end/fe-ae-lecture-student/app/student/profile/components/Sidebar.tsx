...
export default function Sidebar() {
  ...
  return (
    ...
    <aside className="w-full md:w-64 shrink-0 border border-slate-300 self-stretch">
      {/* Không dùng .card để giảm độ bo góc; vẫn border + shadow nhẹ */}
      <nav className="h-full bg-[var(--card)] border border-slate-300 rounded-xl p-3 shadow-sm">
        <ul className="space-y-1 border border-slate-300">
            ...
            return (
              <li key={href}>
                <Link
                  ...
                  className={`w-full flex border-slate-300 items-center gap-3 px-3 py-2 text-sm font-medium transition border rounded-md
