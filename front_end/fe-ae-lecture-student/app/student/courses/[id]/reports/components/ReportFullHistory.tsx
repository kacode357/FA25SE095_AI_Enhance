...
export default function ReportFullHistory({
  ...
  const renderDetailForItem = (item: ReportHistoryItem | null) => {
    ...
    const isCurrent = currentVersion !== null && item.version === currentVersion;
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-2 items-end sm:items-end">
              ...
              <button
                ...
                className={`btn px-3 py-1.5 text-[11px] font-semibold disabled:opacity-60 disabled:cursor-not-allowed ${
                  isCurrent ? "bg-slate-100 text-slate-400" : "btn-blue-slow"
                }`}
              >
